...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const Embed = new EmbedBuilder()
            ...
            .setTimestamp()
            .setFooter({ text: "Blacklisted by zeenbot" })
        ...
        if (BlackListGuildData) return interaction.reply({
            embeds: [
                Embed
                    ...
                    .setDescription(`Your server has been blacklisted from using this bot on <t:${parseInt(BlackListGuildData.Time / 1000)}:R>, for the reason: **${BlackListGuildData.Reason}**`)
            ],
            ephemeral: true
        })
        ...
        if (BlackListUserData) return interaction.reply({
            embeds: [
                Embed
                    .setTitle("Server Blacklisted")
                    .setDescription(`You have been blacklisted from using this bot on <t:${parseInt(BlackListUserData.Time / 1000)}:R>, for the reason: **${BlackListUserData.Reason}**`)
            ],
            ephemeral: true
        })
